...
<body bgcolor=#d8dfea>
    ...
    <?php
        $query = "SELECT id_Jogo, nome_Jogo, dataLanca, players, descricao, tag, classificacao, FK_Usuario_id_Usuario, dataAddJogo, nomeEstudio FROM jogos WHERE codLibera='0'";
            ...
            while (list($id_Jogo, $nome_Jogo, $dataLanca, $players, $descricao, $tag, $classificacao, $FK_Usuario_id_Usuario, $dataAddJogo, $nomeEstudio) = mysqli_fetch_row($result))
            {
                ...
                "
                    ...
                    <tr>
                        ...
                        <td style='width:69px;height:62px;'>
                            <form name='comentar' action='envioJogoDeletar.php?idJogo=".$id_Jogo."' method='post' >
                                        <input type='submit' value ='Negar'align = 'center' margin='0' style='width:69px;height:62px;'>
                            </form>
                            <form name='comentar' action='envioLiberaJogo.php?idJogo=".$id_Jogo."' method='post' >
                                        <input type='submit' value ='Liberar'align = 'center' margin='0' style='width:69px;height:62px;'>
                            </form>
                        </td>
                    </tr>
                </table>
